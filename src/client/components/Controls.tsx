...
export function Icon({ name, size = 15 }: IconProps): React.ReactElement {
  const children: ReactNode[] = []
  if (name === 'sliders' || name === 'settings') {
    children.push(
      <path key="lines" d="M4 6h16M4 12h16M4 18h16" />,
      <circle key="a" cx="8" cy="6" r="2" />,
      <circle key="b" cx="15" cy="12" r="2" />,
      <circle key="c" cx="10" cy="18" r="2" />,
    )
  } else if (name === 'chevronDown') {
    children.push(<path key="path" d="m6 9 6 6 6-6" />)
  } else if (name === 'chevronUp') {
    children.push(<path key="path" d="m18 15-6-6-6 6" />)
  } else if (name === 'check') {
    children.push(<path key="path" d="m5 12 4 4L19 6" />)
  } else if (name === 'restore') {
    children.push(<path key="arrow" d="M9 7H5v4" />, <path key="curve" d="M5 11a7 7 0 1 1 2 6" />)
  } else if (name === 'search') {
    children.push(<circle key="circle" cx="11" cy="11" r="6.5" />, <path key="handle" d="m16 16 4 4" />)
  } else if (name === 'layers') {
    children.push(<path key="top" d="m12 3 8 4-8 4-8-4 8-4Z" />, <path key="middle" d="m4 12 8 4 8-4" />, <path key="bottom" d="m4 17 8 4 8-4" />)
  } else if (name === 'text') {
    children.push(<path key="path" d="M5 5h14M12 5v14M8 19h8" />)
  } else if (name === 'image') {
    children.push(<rect key="rect" x="3" y="4" width="18" height="16" rx="2" />, <circle key="circle" cx="8.5" cy="9" r="1.5" />, <path key="mountain" d="m4 17 5-5 3 3 2-2 6 4" />)
  } else if (name === 'model') {
    children.push(<path key="box" d="m12 3 8 4.5v9L12 21l-8-4.5v-9L12 3Z" />, <path key="top" d="m4 7.5 8 4.5 8-4.5" />, <path key="side" d="M12 12v9" />)
  } else if (name === 'context') {
    children.push(<path key="brackets" d="M8 4H5v16h3M16 4h3v16h-3" />, <path key="lines" d="M10 8h4M10 12h4M10 16h4" />)
  } else if (name === 'sparkles') {
    children.push(<path key="large" d="m12 3-1.2 4.8L6 9l4.8 1.2L12 15l1.2-4.8L18 9l-4.8-1.2L12 3Z" />, <path key="small" d="m19 14-.7 2.3L16 17l2.3.7L19 20l.7-2.3L22 17l-2.3-.7L19 14Z" />)
  }
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false" style={{ display: 'block', flex: '0 0 auto' }}>{children}</svg>
}
