...
export function SubagentSettings({ effort, draft, custom, busy, palette, t, onDraftChange, onCustomChange, onSave }: SubagentSettingsProps): React.ReactElement {
  ...
  return <div style={{ backgroundColor: palette.group, border: `1px solid ${palette.border}`, borderRadius: '8px', boxShadow: palette.shadow, overflow: 'hidden', marginBottom: '8px' }}>
    ...
    <div style={{ padding: '0 8px', fontSize: '12px', color: palette.secondary, marginBottom: '5px' }}>{effort ? t('currentDefault', { effort }) : t('unconfiguredSubagent')}</div>
