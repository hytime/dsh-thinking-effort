...
export interface ModelRowProps {
  ...
  /**
   * Why this model cannot be saved, or `null` when it can. Rendered beside the
   * Save button so a refusal is visible where the user is working; the button
   * is disabled on the same condition.
   */
