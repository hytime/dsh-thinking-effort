...
| 多言語設定 | 中文、English、日本語、한국어を切り替え可能 |
...
2. 上部の **Page language** で `中文`、`English`、`日本語`、`한국어` を選択します。DSH は保存済み locale、ブラウザ言語、最後に中国語の順でフォールバックします。選択は DSH に保存され、リロードや再起動後も維持されます。
