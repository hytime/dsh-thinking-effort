...
See [INSTALL.en.md](./INSTALL.en.md) for profile discovery, migration, validation, and troubleshooting.
...
The settings page shows the installed version as a small watermark such as `v0.1.5` in the bottom-right corner.
